...
import static com.octo.octo_beat_plugin.core.device._enum.RequestCode.BB_REQ_SSL_SET_CA_CERT;
...
public class SetSeverCertificateCmd {
    private static final String TAG = "SetSeverCertificateCmd";
    ...
    public static byte[] response(int response) {
        ...
        jsonArray.put(BB_REQ_SSL_SET_CA_CERT.value);
