...
import static com.octo.octo_beat_plugin.core.device._enum.RequestCode.BB_REQ_GET_NETSTAT;
...
public class NetStatusCmd {
    private static final String TAG = "HandShakeCmd";

    public static byte[] response(int response, boolean isNetworkAvailable) {
        ...
        jsonArray.put(BB_REQ_GET_NETSTAT.value);
        jsonArray.put(response);

        if (response == BB_RSP_OK.value) {
            jsonArray.put(isNetworkAvailable);
        }
